  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.greeting}>Hola Pepe 👋</Text>
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.optionsGrid}>       
          ...
          <Image source={require('../Img/padel.jpeg')} style={styles.optionImage} />
            <Text style={styles.optionTitle}>Padel</Text>
          </TouchableOpacity> 

          <TouchableOpacity style={styles.optionCard}>
          <Image source={require('../Img/tenis.jpeg')} style={styles.optionImage} />
            <Text style={styles.optionTitle}>Tenis</Text>
          </TouchableOpacity>          
          <TouchableOpacity style={styles.optionCard}>
          <Image source={require('../Img/futbol.jpeg')} style={styles.optionImage} />
            <Text style={styles.optionTitle}>Fútbol</Text>
          </TouchableOpacity>        
          <TouchableOpacity style={styles.optionCard}>
          <Image source={require('../Img/basket.jpeg')} style={styles.optionImage} />
