...
const courts = [
  {
    ...
    distance: "2km - Madrid",
    price: "20€",
    image: require("../Img/losnogales.jpeg"),
  ...
  },
  {
    ...
    distance: "1km - Madrid",
    price: "25€",
    image: require("../Img/padelvelo.jpeg"),
  ...
  },
  {
    ...
    distance: "1km - Madrid",
    price: "25€",
    image: require("../Img/m3padel.jpeg"),
    times: ["12:00", "13:00", "14:00", "15:00"],
  },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('ReservarPista', { court: item })}>
